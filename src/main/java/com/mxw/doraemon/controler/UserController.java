...
public class UserController {
	...
	/**
	 * 查询用户列表
	 * http://localhost:8726/user/getUserList?name=alan
	 *
	 * @return
	 */
	@GetMapping("/getUserList")
	public List<User> getUserList(String name) {
		return userDao.getByNameSQLXML(name);
	}


	/**
	 * 根据名称查询用户
	 * http://localhost:8726/user/getUserListByName?userName=Jone
	 *
	 * @param userName
	 * @return
	 */
	...
	/**
	 * 根据名称查询用户
	 * http://localhost:8726/user/getUserListByNameSQL?userName=Jone
	 *
	 * @param userName
	 * @return
	 */
	...
	/**
	 * 保存用户
	 * http://localhost:8726/user/saveUser?name=alan
	 *
	 * @param name
	 * @return
	 */
	...
	/**
	 * http://localhost:8726/user/getUserListByPage?pageNumber=0&pageSize=2
	 *
	 * @param pageNumber
	 * @param pageSize
	 * @return
