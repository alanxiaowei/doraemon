package com.mxw.doraemon.utils.secret.ecc.ecdsa;

import com.mxw.doraemon.utils.secret.ecc.ecdsa.utils.BinaryAscii;
import com.mxw.doraemon.utils.secret.ecc.ecdsa.utils.ByteString;
import com.mxw.doraemon.utils.secret.ecc.ecdsa.utils.Der;
import com.mxw.doraemon.utils.secret.ecc.ecdsa.utils.RandomInteger;
...
public class PrivateKey {
	...
	public ByteString toDer() {
		...
		return Der.encodeSequence(Der.encodeInteger(BigInteger.valueOf(1)), Der.encodeOctetString(this.toByteString()), Der.encodeConstructed(0, Der.encodeOid(this.curve.oid)), Der.encodeConstructed(1, Der.encodeBitString(encodedPublicKey)));
	}
