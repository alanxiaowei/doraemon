...
public class ECCUtils {
	...
	//生成对应的签名，用来验签
	private final static String SIGNATURE = "SHA512withECDSA";
	...
	public static void main(String[] args) {
		try {
			ECPrivateKey privateKey2 = string2PrivateKey("MHcCAQEEIJw7junIWA0Cj1WfASB6yGmBe1+4mYtTxPTl0XcO8K8poAoGCCqGSM49AwEHoUQDQgAEzMW736pFydtDkU+3KIk8wAgQR8i7drXznimBdWt8mSZqdE4L0WamsSgbc0DN7e491ZnR2Fm67S7JpSrRJAmsrQ==");
			ECPublicKey publicKey2 = string2PublicKey("BMzFu9+qRcnbQ5FPtyiJPMAIEEfIu3a1854pgXVrfJkmanROC9FmprEoG3NAze3uPdWZ0dhZuu0uyaUq0SQJrK0=");

			//测试文本
			String content = "hello world 哈哈";

			//加密
			byte[] cipherTxt = encrypt(content.getBytes(), publicKey2);
			System.out.println("content: " + content);
			System.out.println("cipherTxt[" + cipherTxt.length + "]:" + Base64Utils.encode(cipherTxt));
