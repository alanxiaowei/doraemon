...
public class DynamicToken {
	...
	private byte[] sha1(String secret,long msg) throws Exception{
		//创建秘钥
		SecretKey secretKey = new SecretKeySpec(new Base32().decode(secret), "");
		try {
	...
	public static void main(String[] args) {
		DynamicToken dt = new DynamicToken("XAREV5U7DGTHJQ4RXAPMGQ2DRDLFESBY");
		try {
