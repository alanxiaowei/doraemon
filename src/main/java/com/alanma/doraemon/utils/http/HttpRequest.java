...
public class HttpRequest {
	...
	private static String PARAMS_URI = "E:\\工作文档\\workspace\\github\\DoraemonPocketE\\src\\junit\\test\\http\\inparams\\payment_result_req.js";
	...
	public static void postStrut2(String url) {
		...
		params.add(new BasicNameValuePair("cust_acct", "1160316000000324"));
		params.add(new BasicNameValuePair("orderid", "01000000040420160318094929755"));
		params.add(new BasicNameValuePair("amount", "5000000"));
		params.add(new BasicNameValuePair("resultCode", "1"));
		params.add(new BasicNameValuePair("resultMsg", "SUCCESS"));
