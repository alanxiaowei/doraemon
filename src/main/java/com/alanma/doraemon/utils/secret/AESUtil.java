...
import com.alanma.doraemon.utils.string.ByteUtil;
...
public class AESUtil {
	...
	public static void main(String[] args) {
		String key = "23456ujficjdgrje984ifi23ir3idjkw";
		String iv = "random-str-as-IV";
		String secretMsg = encrypt("hello world~", key, iv);
		System.out.println(secretMsg);

		String msg = decrypt(secretMsg, key, iv);
